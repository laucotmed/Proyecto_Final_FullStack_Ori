...
<body>
 ...
 <!--  CONTAINER -->
  <!-- Metemos menú y contenido en un div para poder conseguir que la tarjeta se adapte al espacio que haya en cada momento entre el menú y el slider con la propiedad flex grown en CSS -->
